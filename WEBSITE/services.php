...
<head>
    ...
    <style>
        /* --- Start of Provided/Existing CSS --- */
        .top-info-bar {
        ...
        /* Footer Styles (Copied from previous files for consistency) */
        .footer-section {
            background-color: #1A2E40;
            color: #E0E7EB;
            padding: 60px 0 20px;
...
<body>
    ...
    <div class="hero-section">
        ...
        <div class="container hero-content">
            ...
            <p class="lead text-center">Innovative solutions designed to elevate your business.</p>
        </div>
    </div>
                        ...
                        <div class="col-md-4 col-sm-6 mb-4">
                            <div class="service-card">
                                <?php if (!empty($service['image'])): ?>
                                    <img src="<?php echo htmlspecialchars($service['image']); ?>" alt="<?php echo htmlspecialchars($service['title']); ?>" class="img-fluid service-image">
                                <?php else: ?>
                                    <div class="icon-circle">
                                        <i class="<?php echo htmlspecialchars($service['icon_class'] ?? 'fas fa-cogs'); ?>"></i>
                                    </div>
                                <?php endif; ?>
                                <h5><?php echo htmlspecialchars($service['title']); ?></h5>
                                <p><?php echo htmlspecialchars($service['description']); ?></p>
                                <!-- You can add a "Read More" button if you have a detailed service page for each service -->
                                <!-- <a href="service-details.php?id=<?php echo $service['id']; ?>" class="btn-details">Learn More <i class="fas fa-arrow-right"></i></a> -->
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
